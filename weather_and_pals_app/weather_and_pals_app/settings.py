...
ROOT_URLCONF = 'weather_and_pals_app.urls'
...
WSGI_APPLICATION = 'weather_and_pals_app.wsgi.application'

# Tried getting data from env files, errors when trying to migrate
DATABASES = {
    'default': {
        'ENGINE': 'django.db.backends.postgresql',
        'NAME': 'weather_and_pals_db',
        'USER': 'postgres-user',
        'PASSWORD': 'password',
        'HOST': '127.0.0.1',
        'PORT': '5432',
...
MEDIA_ROOT = '/tmp/weather_and_pals_app/mediafiles'
cloudinary.config(
...
# TODO Fix when index page implemented
